...
//-----------------------Methods-----------------------
  ...
  //Returns an array of SVG Elements that represent the pieces of the QR Code
   ...
   displayLogo(){
     if(this.props.logo){
       return(
          <Image source={this.props.logo} style={[{width: this.props.logoSize, height: this.props.logoSize, position: 'absolute', left: ((this.props.size/2)-(this.props.logoSize/2)), top: ((this.props.size/2)-(this.props.logoSize/2))}, this.props.logoStyle]}/>
       );
     }
     else{
       return (<View/>);
